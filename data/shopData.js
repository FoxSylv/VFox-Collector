const shopData = [
    ...
    {name: "Item Catalogue", value: "items", emoji: "📦", description: "Get one-time use items!", upgrades: [
        ...
        {name: "Government Bribe", value: "bribe", price: 1, minidesc: "Deletes your foxes", quantity: 1, flavor: "It's only illegal if you get caught", extra: "Sets your fox count to zero while preserving shrine upgrades\nYou do not gain any coins from this"},
